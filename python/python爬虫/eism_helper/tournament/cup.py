...
class CupTournament(BaseManager):
    ...
    def get_battle_id(self):
        ...
        # xpath = "//td[@class='marked']/preceding-sibling::td[1]/a"
        xpath = "//td[@class='marked']/parent::tr/td[4]/a"

        try:
            elements = self.driver.find_elements_by_xpath(xpath)
            if elements:
                return elements[-1].get_attribute("href").split("=")[-1]
            else:
